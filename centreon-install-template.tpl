...
MONITORINGENGINE_LOG="/var/log/nagios3"
...
MONITORINGENGINE_INIT_SCRIPT="/etc/init.d/nagios3"
## What is the Monitoring engine binary ?
MONITORINGENGINE_BINARY="/usr/sbin/nagios3"
## What is the Monitoring engine configuration directory ?
MONITORINGENGINE_ETC="/etc/nagios3"
## Where is the configuration directory for broker module ?
BROKER_ETC="/etc/nagios3"
